        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- Lista de links (cada link é um botão do Tabler) -->
                    <div class="glider flex-grow-1">

                        <?php foreach ($categorias as $categoria): ?>
                        <div class="me-2">
                            <a href="<?= INCLUDE_PATH . "categoria?id={$categoria['id']}"; ?>" class="btn btn-6 btn-outline-dark btn-pill btn-lg w-100 ms-1">
                                <?= $categoria['nome']; ?>
                            </a>
                        </div>
                        <?php endforeach; ?>

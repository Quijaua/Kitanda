        ...
        <table class="main bg-body" width="100%" cellspacing="0" cellpadding="0" role="presentation">
            <tr>
                <td align="center" valign="top">
                    <span class="preheader">Seu pagamento foi processado com sucesso</span>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td class="content pb-0" align="center">
                                                                <table class="icon icon-lg bg-blue " cellspacing="0" cellpadding="0" role="presentation">
                                                                    <tr>
                                                                        <td valign="middle" align="center">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                <h4>Pedido nº: #' . htmlspecialchars($content['content']['pedido']['pedido_id'], ENT_QUOTES, 'UTF-8') . '</h4>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table class="row" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td class="col">
                                                                            ...
                                                                            <table class="row">
                                                                                <tr>
                                                                                    <td class="col-mobile">Data do pagamento</td>
                                                                                    <td class="col-mobile">' . htmlspecialchars(date('d/m/Y', strtotime($content['content']['pedido']['data_pagamento'])), ENT_QUOTES, 'UTF-8') . '</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="col-mobile">Pagamento</td>
                                                                                    <td class="col-mobile">' . htmlspecialchars($content['content']['pedido']['forma_pagamento'], ENT_QUOTES, 'UTF-8') . '</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="col-mobile">Total do pedido</td>
                                                                                    <td class="col-mobile">R$ ' . number_format($content['content']['pedido']['total'], 2, ',', '.') . '</td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                        <td class="col-hr"></td>
                                                                        <td class="col">
                                                                            ...
                                                                            ' . htmlspecialchars($content['content']['usuario']['endereco'], ENT_QUOTES, 'UTF-8') . '
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>

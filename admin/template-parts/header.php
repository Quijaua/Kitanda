        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="<?= INCLUDE_PATH_ADMIN; ?>sobre" class="dropdown-item">Instituição</a>
                    <a class="dropdown-item" href="<?= INCLUDE_PATH_ADMIN; ?>sobre">
                        <!-- Download SVG icon from http://tabler.io/icons/icon/browser -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon dropdown-item-icon icon-2 icons-tabler-outline icon-tabler-browser"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 8h16"></path><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path><path d="M8 4v4"></path></svg>
                        Instituição
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?= INCLUDE_PATH_ADMIN; ?>editar-perfil">

                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == "success") {
                            ...
                            $("#updateCategory").before('<div class="alert alert-danger alert-dismissible fade show w-100" role="alert">' + response.message + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Fechar alerta"></button></div>');
                        }
                    ...
                    error: function (xhr, status, error) {
                        ...
                        $(".alert").remove(); // Remove qualquer mensagem de erro anterior
                        $("#updateCategory").before('<div class="alert alert-danger alert-dismissible fade show w-100" role="alert">Ocorreu um erro, tente novamente mais tarde.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Fechar alerta"></button></div>');

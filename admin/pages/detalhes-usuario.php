                    ...
                    <div class="col-lg-12 mt-0">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="nome" name="nome" type="text" class="form-control" value="<?= $usuario['nome']; ?>" disabled>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                if ($usuario['status'] == 1 && empty($usuario['magic_link'])) {
                                                    ...
                                                    echo '<input id="email" name="email" type="email" class="form-control" value="' . htmlspecialchars($usuario['email']) . '">';
                                                }
                                                ?>
                            ...
                            <div class="card-footer text-end">
                                <div class="d-flex">
                                    <button type="button" class="btn btn-1" onclick="location.reload();">Voltar</button>

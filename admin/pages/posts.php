...
<?php
    // Se o usuário possui somente a permissão only_own, filtramos as posts criados por ele.
    if ($read) {
        // Caso contrário, exibe todos as posts
        $stmt = $conn->prepare("
            SELECT *
            FROM tb_blog_posts
            GROUP BY id
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-secondary">Tem certeza de que deseja excluir o post <b>"<span id="postNome"></span>"</b>?</div>
            </div>
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <a href="<?= ($create) ? INCLUDE_PATH_ADMIN."criar-post" : "#"; ?>" class="btn btn-info btn-3 <?= $disabledCreate; ?>" <?= $disabledCreate; ?>>
        ...
        <div class="row row-cards">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <table id="posts" class="table card-table table-vcenter text-nowrap datatable">
                        <thead>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex flex-wrap gap-2 align-items-center">
                                        <!-- Botão Visualizar -->
                                        <a href="<?php echo INCLUDE_PATH . "post?id={$post['id']}"; ?>" target="_blank" class="btn btn-6 btn-outline-primary d-flex align-items-center gap-1">
                                        ...
                                        <?php if ($update): ?>
                                        <!-- Botão Editar -->
                                        <a href="<?= INCLUDE_PATH_ADMIN . "editar-post?id={$post['id']}"; ?>" class="btn btn-6 btn-outline-secondary d-flex align-items-center gap-1">
                                        ...
                                        <!-- Botão Detalhes -->
                                        <a href="<?= INCLUDE_PATH_ADMIN . "editar-post?id={$post['id']}"; ?>" class="btn btn-6 btn-outline-info d-flex align-items-center gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler-edit">
                                                <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"></path>
                                                <path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z"></path>
                                                <path d="M16 5l3 3"></path>
                                        ...
                                        <!-- Botão Deletar -->
                                        <a type="button" class="btn btn-6 btn-outline-danger d-flex align-items-center gap-1 btn-delete" data-id="<?php echo $post['id']; ?>" data-name="<?php echo $post['titulo']; ?>">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn-delete', function () {
            ...
            $('#postNome').text(elementNameToDelete); // Define o nome no modal
        ...
        $('#confirmDelete').on('click', function () {
            if (elementIdToDelete) {
                $.ajax({
                    url: `<?= INCLUDE_PATH_ADMIN; ?>back-end/delete-post.php?id=${elementIdToDelete}`,
                    type: 'GET',

                                ...
                                <td class="text-end">
                                    <span class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="<?php echo INCLUDE_PATH . "post?id={$post['id']}"; ?>" target="_blank">
                                            ...
                                            <?php if ($update): ?>
                                            <a class="dropdown-item" href="<?= INCLUDE_PATH_ADMIN . "editar-post?id={$post['id']}"; ?>">
                                            ...
                                            <button type="button" class="dropdown-item text-danger btn-delete" data-id="<?php echo $post['id']; ?>" data-name="<?php echo $post['titulo']; ?>">
                                                <!-- Download SVG icon from http://tabler.io/icons/icon/edit -->
